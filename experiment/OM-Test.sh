#!/bin/bash
# test the running time and speedups.

CORE="../core-maint/core2"

TIMEOUT_TIME="600s" # timeout
...
# results
OUR_RESULT="${BENCHDIR}/results/results-om-7-22-2022.csv"
...
do_tests() {
    #test sequential without locking
    #test three cases, cas lock
    test_real_offline "${INSERT_SIZE}" "2" "20" "3" "0"
    test_real_offline "${INSERT_SIZE}" "2" "21" "3" "0"
    test_real_offline "${INSERT_SIZE}" "2" "22" "3" "0"
    test_real_offline "${INSERT_SIZE}" "2" "23" "3" "0"

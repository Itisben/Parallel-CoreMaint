...
def parseline(line):
    ...
    parsevar("relabel", line, r"# of relabel: ([\S]+)")
    parsevar("tag",      line, r"# of tag: ([\S]+)")
    parsevar("subtag",      line, r"# of subtag: ([\S]+)")
    
    # for compared methods running time 
    parsevar("Insert",      line, r"Insert: ([\S]+)")
    parsevar("Delete",      line, r"Delete: ([\S]+)")

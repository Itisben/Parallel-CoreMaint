...
#define _gm_atomic_cas_double(ptr, oldval, newval) \
({ \
const int64_t    oldVal = *(reinterpret_cast< int64_t*>(&old_val)); \
const int64_t    newVal = *(reinterpret_cast< int64_t*>(&new_val)); \
__sync_bool_compare_and_swap(reinterpret_cast<volatile int64_t*>(dest), oldVal, newVal); \
})
...
#define _gm_atomic_cas_double(ptr, oldval, newval) _gm_CAS_asm_64(ptr,oldval,newval)
//#define _gm_atomic_cas_float(ptr, oldval, newval) _gm_CAS_asm_32(ptr,oldval,newval)
#define _gm_atomic_cas_float(ptr, oldval, newval) \
({ \
const int    oldVal = *(reinterpret_cast< int*>(&old_val)); \
const int    newVal = *(reinterpret_cast< int*>(&new_val)); \
__sync_bool_compare_and_swap(reinterpret_cast<volatile int*>(dest), oldVal, newVal); \
})
#endif
